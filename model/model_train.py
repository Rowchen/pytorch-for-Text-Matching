...
class net_train():
    ...
    @staticmethod
    def fit(x,y,net,opter,criterion,batch_size=100,num_epoch=1,seed=2018,x_val=None,y_val=None,batch_decay=100,stop_ite=6,eps=0.005,name=None):
        best_score=1000
        lr1=net.lr1
        net.train()
